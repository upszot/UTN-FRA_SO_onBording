...
### Algunos Temas que aprenderemos durante la cursada.
   ...
   - [ ] **Verificar si el Host permite y esta Habilitada la Virtualizacion:**
      - [Habilitar Virtualizacion y Configurar VirtualBox Windows / Mac / Linux](./Preparacion_Entorno_Estudiante/Preparacion_Entorno_Estudiante.md#habilitar-la-virtualizacion)
